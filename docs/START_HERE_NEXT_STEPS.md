...
- First design-thinking baseline:
  ...
  - `20_dataset/seeds/cubesat/package.json`
  - `20_dataset/seeds/cubesat/thinking.jsonl`
  - `20_dataset/seeds/cubesat/validate.py`
- Second design-thinking baseline:
  - `docs/TILTROTOR_REDESIGN_V1.md`
  - `20_dataset/seeds/tiltrotor/package.json`
  - `20_dataset/seeds/tiltrotor/thinking.jsonl`
  - `20_dataset/seeds/tiltrotor/validate.py`
- Third design-thinking baseline:
  - `docs/ROBOT_ARM_REDESIGN_V1.md`
  - `20_dataset/seeds/robot_arm/package.json`
  - `20_dataset/seeds/robot_arm/thinking.jsonl`
  - `20_dataset/seeds/robot_arm/validate.py`
- Fourth design-thinking baseline:
  - `docs/SMALL_LAUNCH_VEHICLE_REDESIGN_V1.md`
  - `20_dataset/seeds/small_launch_vehicle/package.json`
  - `20_dataset/seeds/small_launch_vehicle/thinking.jsonl`
  - `20_dataset/seeds/small_launch_vehicle/validate.py`
- Fifth design-thinking baseline:
  - `docs/LONG_RANGE_RECON_WING_REDESIGN_V1.md`
  - `20_dataset/seeds/long_range_recon_wing/package.json`
  - `20_dataset/seeds/long_range_recon_wing/thinking.jsonl`
  - `20_dataset/seeds/long_range_recon_wing/validate.py`
...
Minimal.html
  ...
  -> schema validation through 10_execution/server/serve.py at 127.0.0.1:8080/validate
```
...
- `00_contract/schema_v6.json`
- preset prompts in `10_execution/prompts/presets/`
...
- `00_contract/schema_v6.json` is visible at repo root
...
- first model: `qwen3:8b`
- fallback models: `qwen2.5:7b`, `qwen3:4b`
...
- include `00_contract/schema_v6.json` guidance
- call the Ollama-compatible API
- return JSON-like output to the browser
- validate final output against `00_contract/schema_v6.json`

Done when:

- `python 10_execution/server/serve.py --no-browser` serves `Minimal.html`
- `GET /schema` returns `00_contract/schema_v6.json`
...
- `00_contract/schema_v6.json`
- `00_contract/presets.json`
- selected `10_execution/prompts/presets/*/sys_template.txt`
- selected `10_execution/prompts/presets/*/usr_template.txt`
...
- responses are consistently organized around `00_contract/schema_v6.json`
