...
```
ollama pull qwen3:8b             # default recommendation for stable JSON + reasoning
# or
ollama pull qwen2.5:7b           # compatibility fallback
ollama pull qwen3:4b             # smaller/faster fallback
ollama pull llama3.1:8b          # English reasoning comparison
ollama pull gemma3:4b            # small comparison candidate
```
