...
3. Review `00_contract/schema_v6.json` as the canonical output contract.
4. Review domain presets under `10_execution/prompts/presets/`.
...
`00_contract/presets.json` and `10_execution/backend.json` are configuration contracts only. They do not start a backend, download models, or run local services.
